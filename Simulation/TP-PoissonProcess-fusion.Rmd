...
As we can see, for the Weibull and square root intensity models, both Crow's and Barlow's tests are powerful. For the sigmoid intensity, neither test performs well, while for the logarithmic intensity, Crow's test is more powerful than Barlow's. This suggests that these two tests are primarily effective for smooth intensities with rapid growth.
